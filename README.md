...
-  $V_{\theta}^{rt}$ : the real target angular velocity received by the robot (recall control delay). It is normalized by the maximal angular velocity of the robot (2 rad/s), thus $\in [-1,1]$
